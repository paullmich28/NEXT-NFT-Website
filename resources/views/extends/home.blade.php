                ...
                <div class="my-lg-auto col-lg-4 col-12 offset-lg-1">
                    <div class="common-container">
                        <div class="pb-2 pr-2 col-6">
                            <img width="400px" height="auto" src="/images/assetBG1.jpg" style="object-fit: cover" />
                        </div>
                    </div>
                </div>
            </div>
...
<div class="positioning1 mt-5">
    <div class="scroll2 text p-2 bg-warning">
        <div>
            ...
            <div class="common-container">
                <div class="row">
                    <div class=" col-lg-4 col-12">
                        <img src="/images/assetBG2.jpg" width="95%" height="auto"/>
                    </div>
                            ...
                            <div class="row">
                                <div class="mb-3 col-lg-7 col-12">
                                    ...
                                    <p class="text-white">
                                        ...
                                        <span>The Creator, The Mastermind of This NFT :)</span> 
                                    </p>
                                    <p class="text-white">
                                        LIUSIANTO,
                                    ...
                                    <p class="text-white">
                                        ...
                                        <span>The Database Enjoyer</span> 
                                    </p>
                                    <p class="text-white">
